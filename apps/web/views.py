...
def menu_view(request):
    ...
    if not categories.exists():
        ...
        demo_menu = {
            "Kebaplar": [
                {"name": "Adana Kebap", "description": "Zırh kıyması ile özel Adana.", "price": 175.00},
                {"name": "Urfa Kebap", "description": "Acısız, yumuşak lezzet.", "price": 170.00},
                {"name": "Beyti Sarma", "description": "Özel sos ve yoğurt eşliğinde.", "price": 195.00},
            ],
            "Yemekler": [
                {"name": "Pilav", "description": "Sade pilav.", "price": 25.00},
                {"name": "Kısır", "description": "Bulgur ve sebzelerle.", "price": 30.00},
                {"name": "Mercimek Köftesi", "description": "Mercimek ve bulgurla.", "price": 35.00},
                {"name": "Patates Kızartması", "description": "Kızarmış patates.", "price": 40.00},
                {"name": "Mevsim Salata", "description": "Taze sebzelerle.", "price": 45.00},
            ],
            "Çorbalar": [
                {"name": "Mercimek Çorbası", "description": "Süzme mercimek.", "price": 45.00},
                {"name": "Kelle Paça Çorbası", "description": "Bol sarımsaklı.", "price": 85.00},
            ],
            "Tatlılar": [
                {"name": "Sütlaç", "description": "Geleneksel sütlaç.", "price": 40.00},
                {"name": "Künefe", "description": "Kadayıf ve peynir ile.", "price": 60.00},
                {"name": "Baklava", "description": "Cevizli baklava.", "price": 50.00},
                {"name": "Trileçe", "description": "Üç katlı tatlı.", "price": 45.00},
            ],
            "İçecekler": [
                {"name": "Ayran", "description": "Bol köpüklü yayık ayran.", "price": 25.00},
                {"name": "Kola", "description": "Soğuk kutu içecek.", "price": 35.00},
                {"name": "Limonata", "description": "Taze sıkım limonata.", "price": 30.00},
                {"name": "Soda", "description": "Soğuk maden suyu.", "price": 20.00},
